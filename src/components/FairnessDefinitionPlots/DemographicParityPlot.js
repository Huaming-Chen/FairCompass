...
class DemographicParityPlot extends Component {
    constructor(props) {
        super(props);
    ...
    loadData = (favOutcome) => {
        ...
        if (favOutcome == 0) {
            ...
            temp = temp.sort((a,b) => a.nr - b.nr); // b - a for reverse sort
        }
        else {
            for (var s of this.props.activeGroups) {
                let name = s.vals.join(" ");
            ...
            temp = temp.sort((a,b) => parseFloat(a.pr) - parseFloat(b.pr)); // b - a for reverse sort
        }
    ...
    render () {        
        return(
            ...
            {this.props.activeGroups &&
                ...
                textAlign: 'left'}}/>
                <Legend />
                {this.state.favOutcome == 0 && (<Bar dataKey="nr" fill="#8884d8"/>)} 
                {this.state.favOutcome == 1 && (<Bar dataKey="pr" fill="#8884d8"/>)} 
            </BarChart>
            }
...
export default DemographicParityPlot;
